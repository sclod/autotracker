...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pb-20 pt-header">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-border/60 bg-card/70 p-8 md:p-12">
            ...
            <div className="relative grid gap-10 md:grid-cols-[1.2fr_0.8fr]">
              <div className="space-y-6">
                <div className="text-xs uppercase tracking-[0.4em] text-muted">Навигация</div>
                <div className="text-[72px] font-semibold leading-none md:text-[96px]">404</div>
                <h1 className="text-3xl font-semibold md:text-4xl">Страница не найдена</h1>
                ...
                <form action="/track" method="get" className="mt-6 flex flex-col gap-3 sm:flex-row">
                  <Input name="trackingNumber" placeholder="Введите номер заказа" className="h-11" />
              ...
              <div className="flex h-full flex-col justify-between rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur">
                <div className="space-y-4">
                  <div className="text-xs uppercase tracking-[0.3em] text-muted">Быстрые ссылки</div>
                ...
                <div className="mt-10 rounded-2xl border border-white/10 bg-white/5 p-4 text-xs text-muted">
                  Если не нашли страницу, напишите менеджеру, поможем с навигацией.
                </div>
              </div>
            </div>
          </div>
